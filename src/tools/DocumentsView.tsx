...
export const DocumentsView = ({ documents, onUpdateDocument }) => (
    <div className="tool-card">
        ...
        <div style={{display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginBottom: '1.5rem'}}>
            <button className="button">Download .zip</button>
            <button className="button button-primary">Generate "HMAP Pack"</button>
        </div>
        ...
        <div className="upload-dropzone"><p>Drag & drop files to upload</p></div>
    </div>
);